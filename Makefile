...
statedir	=	$(localstatedir)/lib/remarkable-printer-app
spooldir	=	$(localstatedir)/spool/remarkable-printer-app
serverbin	=	$(prefix)/lib/remarkable-printer-app
resourcedir	=	$(prefix)/share/remarkable-printer-app
...
# Targets...
OBJS		=	remarkable-printer-app.o
TARGETS		=	remarkable-printer-app
...
install:	$(TARGETS)
	...
	mkdir -p $(ppddir)
	echo NOT cp generic-ps-printer.ppd $(ppddir)
